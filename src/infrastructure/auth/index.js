...
var db_1 = require("../db");
var auth_schema_1 = require("../db/schema/auth.schema");
var magic_link_1 = require("better-auth/plugins/magic-link");
var auth = (0, better_auth_1.betterAuth)({
    ...
    plugins: [
        (0, magic_link_1.magicLink)({
            sendMagicLink: function (_a, _request_1) { return __awaiter(void 0, [_a, _request_1], void 0, function (_b, _request) {
                var email = _b.email, token = _b.token, url = _b.url;
