...
export function RegistrationChart() {
	...
	return (
		<Card className="relative h-full overflow-hidden rounded-2xl border-0 bg-gradient-to-br from-green-500 to-green-600 text-white shadow-lg dark:from-green-400 dark:to-green-500">
